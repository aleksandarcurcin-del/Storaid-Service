            ...
            <div className="choose-flex">
                <div className="choose-left">
                    ...
                    <div className="choose-content">
                        <img src="/images/choose1.svg" alt="security image" />
                    ...
                    <div className="choose-content">
                        <img src="/images/choose2.svg" alt="money bag image" />
                        <div className="content-1">
                    ...
                    <div className="choose-content">
                        <img src="/images/choose3.svg" alt="broom image" />
                        <div className="content-1">
                    ...
                    <div className="choose-content">
                        <img src="/images/choose4.svg" alt="clock image" />
                        <div className="content-1">
